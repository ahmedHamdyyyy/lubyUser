  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(phone, style: const TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.w400)),
...
class CustomTextField extends StatelessWidget {
  ...
  final bool isEnabled, isPassword;
  final String title;
    ...
    return Column(
      children: [
        ...
        if (state.user.id.isNotEmpty) ...[
          ...
          Text(state.user.phone, style: TextStyle(fontSize: 14, color: Colors.grey, fontFamily: 'Poppins')),
        ],
        const SizedBox(height: 20),
      ],
    );
...
class MenuItemWidget extends StatelessWidget {
  ...
  final String title;
  final Widget? screen;
  final bool showArrow, checkLoginFirst;
...
class ProfileInfoText extends StatelessWidget {
  const ProfileInfoText({super.key, required this.firstName, required this.lastName, required this.phone});
  final String firstName;
  final String lastName;
  final String phone;
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(phone, style: TextStyle(fontFamily: 'Poppins', fontSize: 14, color: Colors.grey, fontWeight: FontWeight.w400)),
        const SizedBox(height: 20),
      ],
    );
  }
