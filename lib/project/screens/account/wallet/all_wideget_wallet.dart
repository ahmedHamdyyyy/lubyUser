      ...
      children: [
        ...
        Row(
          children: [
            ...
            TextWidget(text: context.l10n.wallet, color: const Color(0xFF757575), fontSize: 14, fontWeight: FontWeight.w500),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const TextWidget(text: '15,000', color: Color(0xFFFFFFFF), fontSize: 32, fontWeight: FontWeight.w400),
                TextWidget(
...
class CardSelectionWidget extends StatelessWidget {
  ...
  const CardSelectionWidget({super.key, required this.isSelected, required this.onToggle});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(padding: EdgeInsets.only(left: 0.0, right: 272), child: Driver()),
          const SizedBox(height: 16),
          Padding(
            padding: const EdgeInsets.only(left: 16.0),
            child: TextWidget(
              text: context.l10n.cardName,
              color: const Color(0xFF757575),
              fontSize: 16,
              fontWeight: FontWeight.w400,
            ),
...
class ChargeButtonWidget extends StatelessWidget {
  ...
  const ChargeButtonWidget({super.key, required this.onPressed});
...
class AddNewCardButtonWidget extends StatelessWidget {
  ...
  const AddNewCardButtonWidget({super.key, required this.onPressed});
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CardSelectionWidget(isSelected: isFirstCardSelected, onToggle: onFirstCardToggle),
                  const SizedBox(height: 16),
                  CardSelectionWidget(isSelected: isSecondCardSelected, onToggle: onSecondCardToggle),
...
class WalletBalanceCard extends StatelessWidget {
  ...
  const WalletBalanceCard({super.key, required this.balance, required this.currency, required this.onChargingWalletPressed});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              textBaseline: TextBaseline.alphabetic,
              children: [
                TextWidget(text: balance, color: const Color(0xFFFFFFFF), fontSize: 32, fontWeight: FontWeight.w400),
                TextWidget(text: currency, color: const Color(0xFFFFFFFF), fontSize: 16, fontWeight: FontWeight.w400),
              ],
            ),
            Row(
              children: [
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        WalletBalanceCard(balance: balance, currency: currency, onChargingWalletPressed: onChargingWalletPressed),
      ],
    );
  }
}
