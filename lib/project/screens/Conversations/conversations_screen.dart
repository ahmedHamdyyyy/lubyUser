        ...
        body: Column(
          ...
          children: [
            ...
            if (isSignedIn) ...[
                              ...
                              children: [
                                AnimatedBuilder(
                                  ...
                                  child: Icon(
                                    ...
                                    size: 120,
                                    color: AppColors.grayTextColor.withAlpha(100),
                                  ),
                                ),
                          ...
                          return ListTile(
                            ...
                            leading: ClipRRect(
                              ...
                              child: FadeInImage.assetNetwork(
                                ...
                                imageErrorBuilder:
                                    (context, error, stackTrace) => Image.asset('assets/images/saudian_man.png'),
                              ),
                            ),
                            title: Text(
                              chat.vendorName,
              ...
              Expanded(child: SigninPlaceholder(onLoginSuccessfuly: () {})),
          ],
        ),
      );
    },
