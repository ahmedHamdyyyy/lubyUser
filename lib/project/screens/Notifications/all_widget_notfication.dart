...
import '../propreties/views/property_screen.dart';
...
class NotificationDetailContent extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            DateFormat.yMMMd().format(DateTime.parse(notification['date'])),
            style: GoogleFonts.poppins(fontSize: 14, color: AppColors.grayTextColor),
          ),
          const SizedBox(height: 25),

          // Notification content
          buildLongText(context),
  ...
  Widget buildLongText(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          context.l10n.notificationDetailParagraph1,
          style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[700], height: 1.5),
        ),
        const SizedBox(height: 12),
        Text(
          context.l10n.notificationDetailParagraph2,
          style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[700], height: 1.5),
        ),
        const SizedBox(height: 12),
        Text(
          context.l10n.notificationDetailParagraph3,
          style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[700], height: 1.5),
        ),
      ],
    );
