...
//   const FavoriteHeaderWidget({super.key, required this.title, this.onTap, this.showBackButton = true});
...
//               Text("favorite", style: TextStyle(color: AppColors.grayTextColor, fontWeight: FontWeight.w500, fontSize: 14)),
//             ],
//           ),
...
//         children: [
//           Container(width: 120, height: 120, margin: const EdgeInsets.only(bottom: 24), child: SvgPicture.asset(iconAsset)),
//           Text(
//             message,
...
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         FavoriteHeaderWidget(title: 'Your favorite', onTap: onTitleTap, showBackButton: showBackButton),
//         Expanded(child: EmptyFavoriteWidget(iconAsset: iconAsset, message: message)),
//       ],
//     );
//   }
// }
...
//                 ClipRRect(
//                   borderRadius: BorderRadius.circular(10),
//                   child: Image.asset(imageUrl, width: 159, height: 159, fit: BoxFit.cover),
//                 ),
...
//                 Text(location, style: const TextStyle(color: AppColors.grayTextColor, fontSize: 14)),
//                 const SizedBox(height: 4),
//                 Text(
//                   guests,
//                   style: const TextStyle(
