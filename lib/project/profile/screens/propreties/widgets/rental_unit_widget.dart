  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          TextWidget(
            text: 'Entire rental unit in${state.property.address.formattedAddress}',
          ...
          Text(
            ...
            style: TextStyle(color: AppColors.grayTextColor, fontSize: 16, fontWeight: FontWeight.w400),
          ),
        ],
      ),
    );
