...
class PhoneNumberWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          const TextWidget(text: '+966 123456789', color: Color(0xFF636363), fontSize: 16, fontWeight: FontWeight.w400),
          const Spacer(),
          Material(
            child: Container(
              height: 36,
...
class ContactUsContent extends StatelessWidget {
  ...
  const ContactUsContent({super.key, required this.onSendPressed});
