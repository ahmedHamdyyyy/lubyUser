...
import '../../screens/propreties/views/property_screen.dart';
                ...
                Expanded(
                  child:
                      isSignedIn
                                          ...
                                          return InkWell(
                                            onTap: () {
                                              item.type == FavoriteType.property
                                                  ? Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) => PropertyScreen(id: item.itemId)),
                                                  )
                                                  : Navigator.push(
                                                    context,
                          ...
                          : SigninPlaceholder(onLoginSuccessfuly: _login),
                ),
              ],
            ),
          ),
